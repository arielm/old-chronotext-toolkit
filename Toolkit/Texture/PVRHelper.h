 ...
 * - CONS: READING A RAW PVR FILE SHOULD ALWAYS BE THE FASTEST AND MOST-EFFICIENT CHOICE
 * - CONS: BIG APPLICATION SIZES ON OSX AND WINDOWS (BECAUSE THE DATA IN THE APPLICATION-PACKAGE IS NOT ZIPPED)
 * - CONS: BIG "UNPACKAGED APPLICATION-DATA-SIZE" ON IOS (THE SIZE TAKEN ONCE THE APPLICATION-PACKAGE IS UNZIPPED)
 * - PROS: ON IOS AND ANDROID, THE APPLICATION SIZE SHOULD BE THE SAME (BECAUSE THE DATA IN THE APPLICATION-PACKAGE IS ZIPPED)
 * - RECAP: SEEMS TO BE THE IDEAL FORMAT FOR ANDROID, AND EVENTUALLY FOR IOS (IF LOADING-TIME IS MORE IMPORTANT THAN "UNPACKAGED APPLICATION-DATA-SIZE")
 *
